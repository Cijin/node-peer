...
// (from: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/multiparty/index.d.ts)
...
export declare class Form extends events.EventEmitter {
  ...
  once(event: 'part', listener: (part: Part) => void): this
  ...
  once(event: 'field', listener: (name: string, value: string) => void): this
